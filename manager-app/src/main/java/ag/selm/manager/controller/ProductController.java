...
import ag.selm.manager.controller.client.ProductsRestClient;
...
import java.util.Locale;  // ← Добавьте эту строку
...
public class ProductController {
    ...
    public String updateProduct(@ModelAttribute(name = "product", binding  = false) Product product, @Valid UpdateProductPayload payload, BindingResult bindingResult, Model model){
        ...
        else {this.productsRestClient.updateProduct(product.id(),payload.title(),payload.details());
